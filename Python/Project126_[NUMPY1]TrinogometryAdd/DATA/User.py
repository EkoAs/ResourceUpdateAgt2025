...
from . import Progres
from .Progres import Math, Trigonometry, TrinogomeOpsi, Matrixs
...
def matrix_Math():
    ...
    print('''
        ...
        6. Matrix Transpose
          ...
          ''')
    print("Pilihan Matrix (1-6):")
    print('='*50, "\n")
    operator = input("Masukkan opsi (1-6): ")
    print('='*50, "\n")
    match operator:
        case "1": Matrixs.matrix_pangkat_costum()
        # case "1": matrix_pangkat_2()
        # case "3": matrix_operator()
        # case "4": matrix_determinan()
        # case "5": matrix_invers()
